...
var fave = document.querySelector(".js-favorite");

var toggleFave = function toggleFave(e) {
  calcite.preventDefault(e);
  var badge = calcite.closest("badge", e.target);
  var count = badge.querySelector(".badge-count");
  calcite.toggleClass(badge, "badge-blue");
  if (e.target.innerHTML == "Favorited") {
...
calcite.addEvent(fave, calcite.click(), toggleFave);
...
//# sourceMappingURL=favorite-item.js.map
