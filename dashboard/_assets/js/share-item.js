...
},{"matches-selector":6,"most":67}],3:[function(require,module,exports){
"use strict";
...
},{"tiny-emitter":75}],4:[function(require,module,exports){
"use strict";
...
var modal = document.querySelector(".js-sharing-modal");
var delegate = Delegate(modal);

var state = {
  access: "me", // 'org', 'public'
  groups: []
};

var store = Store("sharing-ui");
store(state);

// change access via select
var accesschange = delegate("change", ".js-sharing-select").map(function (e) {
  return e.target.value;
});

accesschange.observe(function (access) {
  state.access = access;
  render();
});

// change groups in filter dropdown
var groupclick = delegate("click", ".js-sharing-group");
var groupremove = delegate("click", ".filter-dropdown-remove");
var groupchanges = groupclick.merge(groupremove);

groupchanges.observe(function (e) {
  var $groups = document.querySelectorAll(".filter-dropdown-active");
  state.groups = calcite.nodeListToArray($groups).map(function (el) {
...
function render() {
  $(".js-sharing-loader").removeClass("is-active");
  var last = store();
  var dirty = JSON.stringify(state) !== JSON.stringify(last);

  // assemble summary message
  var message = "only you";

  if (state.access === "org") {
    message = "your organization";
  } else if (state.access === "public") {
    message = "everybody";
  }

  var punctuation = state.groups.length ? " and the above groups." : ".";
  message += punctuation;
  document.querySelector(".js-sharing-summary").innerHTML = message;

  // if accessible by groups, the public, or an org, show the social sharing ui
  $(".js-sharing-link").addClass("hide");
  if (state.access !== "me" || state.groups.length) {
    if (last.groups.length || last.access !== "me") {
      $(".js-sharing-link").removeClass("hide");
    }
  }

  // if you've changed settings, show save and cancel buttons
  if (dirty) {
    $(".js-sharing-action-bar").removeClass("hide");
  } else {
    $(".js-sharing-action-bar").addClass("hide");
  }
}

// save to local storage
delegate("click", ".js-sharing-save").observe(function (e) {
  $(".js-sharing-loader").addClass("is-active");
  store(state);
  window.setTimeout(render, 800);
});

// reset the state to whatever was in local storage
delegate("click", ".js-sharing-cancel").observe(function (e) {
  state = store();
  document.querySelector(".js-sharing-select").value = state.access;
  // can't figure out how to rebuild the groups list, so groups don't reset on cancel.
  render();
});

},{"./lib/$.js":1,"./lib/delegate.js":2,"./lib/store.js":3,"calcite-web":5,"most":67}],5:[function(require,module,exports){
...
},{"when/lib/Promise":68,"when/lib/decorators/unhandledRejection":70}],9:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../runSource":47,"../sink/Pipe":53}],13:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./combine":15}],14:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../Stream":10,"../base":11,"../sink/Pipe":53,"../source/core":57,"../source/fromArray":60,"./concatMap":16}],15:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../disposable/CompoundDisposable":38,"../invoke":45,"../sink/IndexSink":51,"../sink/Pipe":53,"../source/core":57,"./transform":35}],16:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./mergeConcurrently":26,"./transform":35}],17:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/CompoundDisposable":38,"../scheduler/PropagateTask":48,"../sink/Pipe":53}],18:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../source/ValueSource":56}],19:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../fusion/Filter":42,"../sink/Pipe":53}],20:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./mergeConcurrently":26,"./transform":35}],21:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/AwaitingDisposable":37,"../disposable/CompoundDisposable":38,"../sink/Pipe":53}],22:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./combine":15}],23:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/CompoundDisposable":38,"../scheduler/PropagateTask":48,"../sink/Pipe":53}],24:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../sink/Pipe":53}],25:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../source/fromArray":60,"./mergeConcurrently":26}],26:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../LinkedList":7,"../Promise":8,"../Stream":10,"../disposable/AwaitingDisposable":37}],27:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../Stream":10,"../fatalError":41}],29:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../disposable/CompoundDisposable":38,"../invoke":45,"../sink/Pipe":53}],30:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/AwaitingDisposable":37,"../sink/Pipe":53,"../source/core":57}],31:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../source/MulticastSource":55,"./mergeConcurrently":26,"./timeslice":32,"./transform":35}],32:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../combinator/flatMap":20,"../combinator/slice":30,"../disposable/CompoundDisposable":38,"../sink/Pipe":53,"../source/core":57}],33:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../sink/Pipe":53}],34:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Queue":9,"../Stream":10,"../base":11,"../disposable/CompoundDisposable":38,"../invoke":45,"../sink/IndexSink":51,"../sink/Pipe":53,"../source/core":57,"./transform":35}],37:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../base":11}],39:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../base":11}],41:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../sink/Pipe":53}],44:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../base":11,"../sink/Pipe":53,"./Filter":42,"./FilterMap":43}],45:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./Promise":8,"./scheduler/defaultScheduler":50,"./sink/Observer":52}],48:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./../Promise":8,"./../base":11}],50:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./Scheduler":49}],51:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../base":11,"../disposable/Disposable":39}],55:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../base":11}],56:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../scheduler/PropagateTask":48}],57:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/Disposable":39,"../disposable/EmptyDisposable":40,"../scheduler/PropagateTask":48,"../source/ValueSource":56}],58:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"./AsyncSource":54,"./MulticastSource":55}],59:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../iterable":46,"./fromArray":60,"./fromIterable":62}],60:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../scheduler/PropagateTask":48}],61:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../base":11,"../scheduler/PropagateTask":48,"./MulticastSource":55}],62:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../iterable":46,"../scheduler/PropagateTask":48}],63:[function(require,module,exports){
...
},{"../Promise":8,"../Stream":10,"../base":11}],64:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../Stream":10}],65:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Stream":10,"../disposable/Disposable":39,"../scheduler/PropagateTask":48,"./MulticastSource":55}],66:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"../Promise":8,"../Stream":10}],67:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2015 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
},{"./lib/Stream":10,"./lib/base":11,"./lib/combinator/accumulate":12,"./lib/combinator/applicative":13,"./lib/combinator/build":14,"./lib/combinator/combine":15,"./lib/combinator/concatMap":16,"./lib/combinator/delay":17,"./lib/combinator/errors":18,"./lib/combinator/filter":19,"./lib/combinator/flatMap":20,"./lib/combinator/flatMapEnd":21,"./lib/combinator/lift":22,"./lib/combinator/limit":23,"./lib/combinator/loop":24,"./lib/combinator/merge":25,"./lib/combinator/observe":27,"./lib/combinator/promises":28,"./lib/combinator/sample":29,"./lib/combinator/slice":30,"./lib/combinator/switch":31,"./lib/combinator/timeslice":32,"./lib/combinator/timestamp":33,"./lib/combinator/transduce":34,"./lib/combinator/transform":35,"./lib/combinator/zip":36,"./lib/source/core":57,"./lib/source/create":58,"./lib/source/from":59,"./lib/source/fromEvent":61,"./lib/source/generate":63,"./lib/source/iterate":64,"./lib/source/periodic":65,"./lib/source/unfold":66}],68:[function(require,module,exports){
/** @license MIT License (c) copyright 2010-2014 original author or authors */
/** @author Brian Cavalier */
/** @author John Hann */
...
//# sourceMappingURL=share-item.js.map
