...
var settings = document.querySelector(".js-updater");
var button = settings.querySelector(".btn");
var title = settings.querySelector(".title-input");
var tags = settings.querySelector(".tag-input");
var description = settings.querySelector(".description-input");

var alert = document.querySelector(".js-item-updated");
var alertClose = document.querySelector(".js-close-alert");
console.log(alertClose);

var activateButton = function activateButton(e) {
...
var fireAlert = function fireAlert() {
