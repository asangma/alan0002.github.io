...
//   let badge = calcite.closest('badge', e.target)
//   let count = badge.querySelector('.badge-count')
//   calcite.toggleClass(badge, 'badge-blue')
//   if ( e.target.innerHTML == "Watching" ) {
//     e.target.innerHTML = "Watch"
//     count.innerHTML = '4'
//   } else {
//     e.target.innerHTML = "Watching"
//     count.innerHTML = '5'
//   }
// }
// console.log(watch, calcite.click(), toggleWatch)
// calcite.addEvent(watch, calcite.click(), toggleWatch);
));
