...
var labels = {
  last48hours: ["July 20", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "July 21", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
  last7Days: ["July 14", "", "", "", "", "July 15", "", "", "", "", "July 16", "", "", "", "", "July 17", "", "", "", "", "July 18", "", "", "", "", "", "July 19", "", "", "", "", "July 20"],
  last30Days: ["June 20", "June 21", "June 22", "June 23", "June 24", "June 25", "June 26", "June 27", "June 28", "June 29", "June 30", "June 31", "July 1", "July 2", "July 3", "July 4", "July 5", "July 6", "July 7", "July 8", "July 9", "July 10", "July 11", "July 12", "July 13", "July 14", "July 15", "July 16", "July 17", "July 18", "July 19", "July 20"],
  last45Days: ["June 5", "June 6", "June 7", "June 8", "June 9", "June 10", "June 11", "June 12", "June 13", "June 14", "June 15", "June 16", "June 17", "June 18", "June 19", "June 20", "June 21", "June 22", "June 23", "June 24", "June 25", "June 26", "June 27", "June 28", "June 29", "June 30", "June 31", "July 1", "July 2", "July 3", "July 4", "July 5", "July 6", "July 7", "July 8", "July 9", "July 10", "July 11", "July 12", "July 13", "July 14", "July 15", "July 16", "July 17", "July 18", "July 19", "July 20"],
  last6Months: ["January 20", "", "", "", "", "February 20", "", "", "", "", "March 20", "", "", "", "", "April 20", "", "", "", "", "May 20", "", "", "", "", "June 20", "", "", "", "", "July 20"]
};

var data = {
  requests: {
    last48hours: [2, 6, 8, 15, 24, 18, 4, 12, 8, 6, 12, 13, 2, 16, 30, 28, 10, 13, 8, 6, 14, 18, 34, 23, 4, 6, 7, 8, 5, 0, 2, 7],
    last7Days: [2, 6, 8, 15, 24, 18, 4, 12, 8, 6, 12, 13, 2, 16, 30, 28, 10, 13, 8, 6, 14, 18, 34, 23, 4, 6, 7, 8, 5, 0, 2, 7],
    last30Days: [100, 82, 86, 76, 82, 78, 98, 87, 106, 90, 87, 94, 98, 145, 120, 125, 127, 135, 108, 127, 189, 187, 165, 176, 178, 187, 168, 178, 198, 187, 189, 207],
    last45Days: [100, 82, 86, 76, 82, 78, 98, 87, 106, 90, 87, 94, 98, 145, 120, 125, 127, 135, 108, 127, 189, 187, 165, 176, 178, 187, 168, 178, 198, 187, 189, 207]
  }
};

var chart = {
  labels: labels.last30Days,
  series: [data.requests.last30Days]
};
...
var bandwidthOptions = assign({}, options, {
  axisY: {
...
var creditOptions = assign({}, options, {
  axisY: {
    offset: 60,
    low: 0,
    high: 7
...
function getBandwidth(chart) {
  var newChart = assign({}, chart);
  newChart.series = [chart.series[0].map(function (num) {
    return num * 0.08 + Math.random() * 0.1;
  })];
  return newChart;
}

function getCredits(chart) {
  var newChart = assign({}, chart);
  newChart.series = [chart.series[0].map(function (num) {
    return 1 + num / 80 - Math.random() / 20;
  })];
  return newChart;
}

var requests = new Chartist.Line(".js-requests-chart", chart, options);
var bandwidth = new Chartist.Line(".js-bandwidth-chart", getBandwidth(chart), bandwidthOptions);
var credits = new Chartist.Line(".js-credits-chart", getCredits(chart), creditOptions);

},{"chartist":2,"object-assign":3}],2:[function(require,module,exports){
