...
function(declare, lang) {
  ...
  var TimeExtent = declare(null, {
    ...
    _create: function(/*Date*/ start, /*Date*/ end) {
      this.startTime = start ? new Date(start.getTime()) : null;
      this.endTime = end ? new Date(end.getTime()) : null;
    },
    
    // reference data for calculating date/time offsets
    _refData: {
    ...
    _getOffsettedDate: function(inDate, offset, units) {
      /*// Test cases:
      console.log("45000 ms - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 45000, "esriTimeUnitsMilliseconds"));
      console.log("1000 s - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 1000, "esriTimeUnitsSeconds"));
      console.log("1500 m - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 1500, "esriTimeUnitsMinutes"));
      console.log("100 h - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 100, "esriTimeUnitsHours"));
      console.log("100 days - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 100, "esriTimeUnitsDays"));
      console.log("100 weeks - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 100, "esriTimeUnitsWeeks"));
      console.log("100 months - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 100, "esriTimeUnitsMonths"));
      console.log("100 years - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 100, "esriTimeUnitsYears"));
      console.log("7 decades - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 7, "esriTimeUnitsDecades"));
      console.log("5 centuries - ", esri.TimeExtent.prototype._getOffsettedDate(new Date(1990, 0, 1), 5, "esriTimeUnitsCenturies"));*/
