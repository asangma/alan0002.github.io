  ...
  var main = function() {
    ...
    defineProperties(Array.prototype, {
      copyWithin: function(target, start) {
        ...
        var final_ = end < 0 ? Math.max(len + end, 0) : Math.min(end, len);
        var count = Math.min(final_ - from, len - to);
        var direction = 1;
...
// commented out because this shim causes an exception in Chrome (at least up to Chrome 30)
//      // 19.1.3.9
