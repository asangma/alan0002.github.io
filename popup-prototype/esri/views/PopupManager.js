      ...
      //  popupLayers = popupLayers.concat(subLayers);
        ...
        if(!clickGraphic){
          ...
          deferredsArray = array.map(popupLayers, function(layer) {
            ...
            if (layer.declaredClass === "esri.layers.ArcGISImageLayer") {
              ...
              queryOptions.layerView = layerView; // needed by Identify to compute current pixelSize
              dfd = layer.queryVisibleRasters(query, queryOptions);
              dfd.then(function(visibleRasters) {
