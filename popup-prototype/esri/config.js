...
define(["require", "exports"], function (require, exports) {
    ...
    var config = {
        ...
        kmlServiceUrl: null,
        /**
         * The URL of the portal instance. If using an on premise portal, this value
         * should be set to the portal instance.
         *
         * The syntax should look something like the following (replace `{HOSTNAME}` with the
         ...
         * @see {@link module:esri/portal/Portal#url Portal.url}
         *
         * @example
         ...
         */
        request: {
            corsDetection: !(window && window.cordova),
         ...
         * @ignore
         */
        useSpatialIndex: !!(window && window.Worker && false) //once kinks are ironed out this can be true
    };
    return config;
});
