...
function (declare, lang) { 
  var PixelFilterWebGL = declare("PixelFilterWebGL", [], {
    ...
    constructor: function (options) {
      ...
      this.altitude = (options && options.altitude) ? options.altitude : 45.0;
      this.azimuth = (options && options.azimuth) ? options.azimuth : 315.0;
      this.zFactor = (options && options.zFactor) ? options.zFactor : 1.0;
      this.hillshade = lang.hitch(this, this.hillshade);
      this.getShader = lang.hitch(this, this.getShader);
      this.loadProgram = lang.hitch(this, this.loadProgram);
    },

    hillshade: function (pixelData) {
      ...
      try {
        ...
        var fragmentshader = this.getShader(gl, "2d-fragment-shader-hillshade");
        ...
        var altitude = this.altitude === undefined ? 45.0 : this.altitude;
        var azimuth = this.azimuth === undefined ? 315.0 : this.azimuth;
        var zFactor = this.zFactor === undefined ? 1.0 : this.zFactor; 
        ...
        var altitudeLocation = gl.getUniformLocation(this.pictureprogram, "u_altitude");
        gl.uniform1f(altitudeLocation, altitude);
        var azimuthLocation = gl.getUniformLocation(this.pictureprogram, "u_azimuth");
        gl.uniform1f(azimuthLocation, azimuth);
        var zfactorLocation = gl.getUniformLocation(this.pictureprogram, "u_zfactor");
        gl.uniform1f(zfactorLocation, zFactor);
        ...
        var numberFlagLocation = gl.getUniformLocation(this.pictureprogram, "u_singleNumberInRGBA");
        gl.uniform1i(numberFlagLocation, 0);
