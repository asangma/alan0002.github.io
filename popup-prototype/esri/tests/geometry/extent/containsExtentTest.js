dojo.provide("esri.tests.geometry.extent.containsExtentTest");
...
doh.registerGroup("geometry.extent.containsExtentTest", [{
    name: "WithinExtent",
    timeout: 5000,
    runTest: function(t){
        var extentJson = {
        ...
        t.assertTrue(extent.contains(extentTest));
        
    }
}, {
    name: "crossExtentLine",
    timeout: 5000,
    runTest: function(t){
        var extentJson = {
        ...
        var extentTest = new esri.geometry.Extent(extentJson);
        t.assertFalse(extent.contains(extentTest));
    }
}, {
    name: "outSideExtent",
    timeout: 5000,
