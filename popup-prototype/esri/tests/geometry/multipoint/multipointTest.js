dojo.provide("esri.tests.geometry.multipoint.multipointTest");
...
doh.registerGroup("geometry.multipoint.multipointTest", [
    {
        name: "testInstanceOf",
        timeout: 5000,
        runTest: function(t)
        {
            ...
            {       
                var multiPoint = featureSet.features[0].geometry;           
        ...
        runTest: function(t)
        {
            ...
            {       
                ...
                for(var i = 0,i1 = features.length; i < i1; i++)
                {
                    ...
                    multiPoint.addPoint(pointsData[i]);
                }
        ...
        runTest: function(t)
		{
            ...
            function showResults(featureSet)
			{
                ...
                for(var i = 0,i1 = features.length; i < i1; i++)
                {
                    ...
                    multiPoint.addPoint(pointCoords);
                }
    ...
    },
    {
        ...
        {		
            ...
            function showResults(featureSet)
			{
                ...
                {
                    pointsData[i] = features[i].geometry;
                    multiPoint.addPoint(pointsData[i].toJSON());
                }
