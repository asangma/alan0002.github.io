dojo.provide("esri.tests.geometry.point.pointToJsonTest");
...
doh.registerGroup("geometry.point.pointToJsonTest", [
    {
        name: "testInstanceOf",
        timeout: 5000,
        runTest: function(t)
        {
            ...
            {       
                ...
                var point = new esri.geometry.Point(pt.toJSON());
    ...
    }/*,   	
    {
        ...
        {       
            ...
            function showResults(featureSet)
            {
                ...
                var str = "esri.geometry.Point(7667299.00009452, 691389.9375, esri.SpatialReference(wkid = 102726))";
