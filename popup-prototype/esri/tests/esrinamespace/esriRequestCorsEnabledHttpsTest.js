dojo.provide("esri.tests.esrinamespace.esriRequestCorsEnabledHttpsTest");
...
doh.registerGroup("esrinamespace.esriRequestCorsEnabledHttpsTest", [
    ...
    runTest: function(t){
        ...
        setIntent(true, false, false, /*Proxy*/ proxyExpectation,false);
        esri.request({
    ...
    runTest: function(t){
        console.log("test2");
		    var proxyExpectation = (window.location.href).toLowerCase().indexOf("https:") === 0 ? false : true;
        setIntent(false, true, false, proxyExpectation,false);
        esri.request({
            url: window.location.href.replace(/^https?/i, "https"),
    ...
    runTest: function(t){
       ...
       t.assertTrue(setIntent.isXhrGet);
	   t.assertFalse(setIntent.isProxy);//cross domain  proxy
    ...
    runTest: function(t){
        ...
        setIntent(!scriptGetExpectation, false, scriptGetExpectation, false,false);
