dojo.provide("esri.tests.esrinamespace.esriRequestCorsEnabledEmptyTest");
...
doh.registerGroup("esrinamespace.esriRequestCorsEnabledEmptyTest", [
    ...
    runTest: function(t){
        ...
        setIntent(true, false, false, false);
    ...
    runTest: function(t){
        console.log("test29");
		esri.config.request.forceProxy = true;
        setIntent(true, false, false, true);
