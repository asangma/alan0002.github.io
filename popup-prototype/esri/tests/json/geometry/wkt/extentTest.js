dojo.provide("esri.tests.json.geometry.wkt.extentTest");
...
doh.registerGroup("json.geometry.wkt.extentTest", [{
    name: "testExtent",
    timeout: 3000,
    runTest: function(t){
        
		t.assertEqual("GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]]",extent.spatialReference.wkt);
