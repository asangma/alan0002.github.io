dojo.provide("esri.tests.json.geometry.wkt.polygonMultiRingsTest");
...
doh.registerGroup("json.geometry.wkt.polygonMultiRingsTest", [{
    name: "testPolygon",
    timeout: 3000,
    runTest: function(t){
		...
		t.assertEqual("GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137,298.257223563]],PRIMEM[\"Greenwich\",0],UNIT[\"Degree\",0.017453292519943295]]",polygon.spatialReference.wkt);
