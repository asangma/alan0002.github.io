dojo.provide("esri.tests.tasks.find.findParam_outSpatialReferenceTest");

dojo.require("esri.tasks.find");  

var findTask, params, outSR;

doh.registerGroup("tasks.find.findParam_outSpatialReferenceTest",
	[
		{
			name: "testPointLayer",
			timeout: 5000,
