dojo.provide("esri.tests.tasks.find.findResult_foundFieldNameTest");

dojo.require("esri.tasks.find");  

var findTask, params;

doh.registerGroup("tasks.find.findResult_foundFieldNameTest",
	[
		{
			name: "testPointLayer",
			timeout: 5000,
			runTest: function(t)
			{		
				var expectedResultString = "DISTRICT";
				...
				function showResults(results) 
				{
				    ...
				    {			
						...
						//console.debug(results[i].displayFieldName);
				      	t.assertEqual(expectedResultString, results[i].foundFieldName);
				      	}
				    }
		...
		},
		{
			...
			runTest: function(t)
			{
				var expectedResultString = "species";
		...
		},
		{
			...
			runTest: function(t)
			{
				var expectedResultString = "FTYPE";
