dojo.provide("esri.tests.tasks.find.findResult_layerIdTest");

dojo.require("esri.tasks.find");  

var findTask, params;

doh.registerGroup("tasks.find.findResult_layerIdTest",
	[
		{
			name: "testPointLayer",
			timeout: 5000,
				...
				function showResults(results) 
				{
				    ...
				    {			
						...
						//console.debug(results[i].displayFieldName);
				      	t.assertEqual(expectedResultString, results[i].layerId);
				      	}
				    }
