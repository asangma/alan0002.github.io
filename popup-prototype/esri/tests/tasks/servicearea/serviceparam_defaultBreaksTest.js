dojo.provide("esri.tests.tasks.servicearea.serviceparam_defaultBreaksTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_defaultBreaksTest", [{
    name: "serviceparam_defaultBreaksTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.defaultBreaks= [1,2];
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual([1,2],serviceTaskParams.defaultBreaks);
