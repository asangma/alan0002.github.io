dojo.provide("esri.tests.tasks.servicearea.serviceparam_outputGeometryPrecisionTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_outputGeometryPrecisionTest", [{
    name: "serviceparam_outputGeometryPrecisionTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.outputGeometryPrecision= 0.5;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual(0.5,serviceTaskParams.outputGeometryPrecision);
