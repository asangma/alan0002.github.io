dojo.provide("esri.tests.tasks.servicearea.serviceparam_restrictionAttributesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_restrictionAttributesTest", [{
    name: "serviceparam_restrictionAttributesTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.restrictionAttributes = ["OneWay"];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual(["OneWay"],serviceTaskParams.restrictionAttributes);
