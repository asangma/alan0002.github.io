dojo.provide("esri.tests.tasks.servicearea.service_facilitiesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.service_facilitiesTest", [{
    name: "service_facilitiesTest",
    timeout: 3000,
    runTest: function(){
        ...
        function showResults(solveResult){
            ...
            console.log("f:" + dojo.toJson(solveResult.facilities));
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    doh.assertEqual("point", solveResult.facilities[0].geometry.type);
