dojo.provide("esri.tests.tasks.servicearea.serviceparam_outputPolygonsTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_outputPolygonsTest", [{
    name: "serviceparam_outputPolygonsTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.outputPolygons= esri.tasks.NAOutputPolygon.SIMPLIFIED;
;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					...
					doh.assertEqual(esri.tasks.NAOutputPolygon.SIMPLIFIED,serviceTaskParams.outputPolygons);
