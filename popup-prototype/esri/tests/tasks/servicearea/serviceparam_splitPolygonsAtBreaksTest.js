dojo.provide("esri.tests.tasks.servicearea.serviceparam_splitPolygonsAtBreaksTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_splitPolygonsAtBreaksTest", [{
    name: "serviceparam_splitPolygonsAtBreaksTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.splitPolygonsAtBreaks= false;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertFalse(serviceTaskParams.splitPolygonsAtBreaks);
