dojo.provide("esri.tests.tasks.servicearea.serviceparam_trimOuterPolygonTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_trimOuterPolygonTest", [{
    name: "serviceparam_trimOuterPolygonTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.trimOuterPolygon= false;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertFalse(serviceTaskParams.trimOuterPolygon);
