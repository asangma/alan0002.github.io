dojo.provide("esri.tests.tasks.servicearea.serviceparam_accumulateAttributesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_accumulateAttributesTest", [{
    name: "serviceparam_accumulateAttributesTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.accumulateAttributes= ["Length","Time"];
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual(["Length","Time"],serviceTaskParams.accumulateAttributes);
