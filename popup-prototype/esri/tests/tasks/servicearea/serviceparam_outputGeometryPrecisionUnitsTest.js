dojo.provide("esri.tests.tasks.servicearea.serviceparam_outputGeometryPrecisionUnitsTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_outputGeometryPrecisionUnitsTest", [{
    name: "serviceparam_outputGeometryPrecisionUnitsTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.outputGeometryPrecisionUnits= "esriUnknownUnits";
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual("esriUnknownUnits",serviceTaskParams.outputGeometryPrecisionUnits);
