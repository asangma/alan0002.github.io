dojo.provide("esri.tests.tasks.servicearea.serviceparam_restrictUTurnsTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_restrictUTurnsTest", [{
    name: "serviceparam_restrictUTurnsTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.restrictUTurns= esri.tasks.NAUTurn.ALLOW_BACKTRACK;
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual(esri.tasks.NAUTurn.ALLOW_BACKTRACK,serviceTaskParams.restrictUTurns);
