dojo.provide("esri.tests.tasks.servicearea.serviceparam_impedanceAttributeTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_impedanceAttributeTest", [{
    name: "serviceparam_impedanceAttributeTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.impedanceAttribute= "Length";
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual("Length",serviceTaskParams.impedanceAttribute);
