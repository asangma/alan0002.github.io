dojo.provide("esri.tests.tasks.servicearea.serviceparam_travelDirectionTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_travelDirectionTest", [{
    name: "serviceparam_travelDirectionTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.travelDirection= esri.tasks.NATravelDirection.FROM_FACILITY;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					...
					doh.assertEqual(esri.tasks.NATravelDirection.FROM_FACILITY,serviceTaskParams.travelDirection);
