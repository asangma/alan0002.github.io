dojo.provide("esri.tests.tasks.servicearea.serviceparam_trimPolygonDistanceTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_trimPolygonDistanceTest", [{
    name: "serviceparam_trimPolygonDistanceTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.trimPolygonDistance= 150;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual(150,serviceTaskParams.trimPolygonDistance);
