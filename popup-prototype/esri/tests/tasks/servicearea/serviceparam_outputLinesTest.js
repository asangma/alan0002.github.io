dojo.provide("esri.tests.tasks.servicearea.serviceparam_outputLinesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_outputLinesTest", [{
    name: "serviceparam_outputLinesTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.outputLines= "esriNAOutputLineNone";
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual("esriNAOutputLineNone",serviceTaskParams.outputLines);
