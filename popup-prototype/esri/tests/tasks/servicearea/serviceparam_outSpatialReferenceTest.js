dojo.provide("esri.tests.tasks.servicearea.serviceparam_outSpatialReferenceTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_outSpatialReferenceTest", [{
    name: "serviceparam_outSpatialReferenceTest",
    timeout: 3000,
    runTest: function(){
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertEqual("4140",serviceTaskParams.outSpatialReference.wkid);
