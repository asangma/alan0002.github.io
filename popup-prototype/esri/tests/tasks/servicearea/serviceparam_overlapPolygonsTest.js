dojo.provide("esri.tests.tasks.servicearea.serviceparam_overlapPolygonsTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_overlapPolygonsTest", [{
    name: "serviceparam_overlapPolygonsTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.overlapPolygons= false;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertFalse(serviceTaskParams.overlapPolygons);
