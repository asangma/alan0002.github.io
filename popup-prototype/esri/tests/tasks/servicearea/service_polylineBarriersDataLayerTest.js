dojo.provide("esri.tests.tasks.servicearea.service_polylineBarriersDataLayerTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.service_polylineBarriersDataLayerTest", [{
    name: "service_polylineBarriersDataLayerTest",
    timeout: 3000,
    runTest: function(){
