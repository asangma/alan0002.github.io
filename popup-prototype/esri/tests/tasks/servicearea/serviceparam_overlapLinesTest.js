dojo.provide("esri.tests.tasks.servicearea.serviceparam_overlapLinesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_overlapLinesTest", [{
    name: "serviceparam_overlapLinesTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.overlapLines= false;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertFalse(serviceTaskParams.overlapLines);
