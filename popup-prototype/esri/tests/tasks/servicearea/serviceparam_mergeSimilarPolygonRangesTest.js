dojo.provide("esri.tests.tasks.servicearea.serviceparam_mergeSimilarPolygonRangesTest");

dojo.require("esri.tasks.servicearea");

var serviceTask, serviceTaskParams;

doh.registerGroup("tasks.servicearea.serviceparam_mergeSimilarPolygonRangesTest", [{
    name: "serviceparam_mergeSimilarPolygonRangesTest",
    timeout: 3000,
    runTest: function(){
        serviceTaskParams = new esri.tasks.ServiceAreaParameters();
        serviceTaskParams.mergeSimilarPolygonRanges= true;
        //add incidents
        var graphicFeatures = [];
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
					doh.assertTrue(serviceTaskParams.mergeSimilarPolygonRanges);
