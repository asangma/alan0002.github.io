dojo.provide("esri.tests.tasks.query.queryGeometryTest");

dojo.require("esri.tasks.query");

var queryTask, query;

doh.registerGroup("tasks.query.queryGeometryTest", [
  

  {
    name: "queryGeometryPoint",
    timeout: 3000,
    runTest: function(t)
    {
