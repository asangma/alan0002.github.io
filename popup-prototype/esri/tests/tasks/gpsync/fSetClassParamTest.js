dojo.provide("esri.tests.tasks.gpsync.fSetClassParamTest");

dojo.require("esri.tasks.gp");

var gpTask;

doh.registerGroup("tasks.gpsync.fSetClassParamTest", [{
    name: "gpSync",
    timeout: 6000,
    runTest: function(t){
...
}], function()//setUp()
{
    ...
    gpTask = new esri.tasks.Geoprocessor("http://servery/ArcGIS/rest/services/GPServices/byVal_sync/GPServer/FSetFClassParamTests");
}, function()//tearDown
{
    gpTask = null;
});
