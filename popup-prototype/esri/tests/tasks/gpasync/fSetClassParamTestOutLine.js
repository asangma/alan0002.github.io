dojo.provide("esri.tests.tasks.gpasync.fSetClassParamTestOutLine");

dojo.require("esri.tasks.gp");

var gpTask;

doh.registerGroup("tasks.gpasync.fSetClassParamTestOutLine", [{
    name: "gpAsync",
    timeout: 6000,
    runTest: function(t){
        //create input param
        ...
        function showResult(jobInfo){
            gpTask.getResultData(jobInfo.jobId, "Output_Line_Shp");
        }
