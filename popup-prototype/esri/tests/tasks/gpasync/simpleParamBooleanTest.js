dojo.provide("esri.tests.tasks.gpasync.simpleParamBooleanTest");

dojo.require("esri.tasks.gp");

var gpTask;

doh.registerGroup("tasks.gpasync.simpleParamBooleanTest", [{
    name: "gpAsync",
    timeout: 3000,
    runTest: function(t){
        //create input param
        ...
        function showResult(jobInfo){
        	gpTask.getResultData(jobInfo.jobId, "Output_Boolean");
        }
        function getData(result){
            t.assertEqual(result.dataType,"GPBoolean");
			t.assertFalse(result.value);
			d.callback(true);
