dojo.provide("esri.tests.tasks.closestfacility.closestParams_accumulateAttributes");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_accumulateAttributes", [{
    name: "closestParams_accumulateAttributes",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.accumulateAttributes = ["Length","Time"];      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual(["Length","Time"],closestParams.accumulateAttributes);
