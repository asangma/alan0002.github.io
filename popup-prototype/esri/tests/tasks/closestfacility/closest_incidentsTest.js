dojo.provide("esri.tests.tasks.closestfacility.closest_incidentsTest");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closest_incidentsTest", [{
    name: "closest_incidentsTest",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
        closestParams.returnIncidents = true;
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
						doh.assertEqual(1,solveResult.incidents.length);
