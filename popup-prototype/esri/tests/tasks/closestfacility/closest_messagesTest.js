dojo.provide("esri.tests.tasks.closestfacility.closest_messagesTest");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closest_messagesTest", [{
    name: "closest_messagesTest",
    timeout: 3000,
    runTest: function(){
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    console.log(solveResult.messages);
        ...
        dojo.connect(closestTask,"onSolveComplete",showResults);
		dojo.connect(closestTask, "onError", errorHandler);
		closestTask.solve(closestParams);
        return d;
    }
}], function()//setUp()
{
