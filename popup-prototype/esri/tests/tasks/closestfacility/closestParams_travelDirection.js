dojo.provide("esri.tests.tasks.closestfacility.closestParams_travelDirection");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_travelDirection", [{
    name: "closestParams_travelDirection",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.travelDirection = "esriNATravelDirectionToFacility";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("esriNATravelDirectionToFacility",closestParams.travelDirection);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
