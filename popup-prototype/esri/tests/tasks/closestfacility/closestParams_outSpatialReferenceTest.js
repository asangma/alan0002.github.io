dojo.provide("esri.tests.tasks.closestfacility.closestParams_outSpatialReferenceTest");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_outSpatialReferenceTest", [{
    name: "closestParams_outSpatialReferenceTest",
    timeout: 3000,
    runTest: function(){
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual(102100,closestParams.outSpatialReference.wkid);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
