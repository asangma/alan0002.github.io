dojo.provide("esri.tests.tasks.closestfacility.closestParams_outputGeometryPrecisionUnits");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_outputGeometryPrecisionUnits", [{
    name: "closestParams_outputGeometryPrecisionUnits",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.outputGeometryPrecisionUnits = "esriUnknownUnits";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("esriUnknownUnits",closestParams.outputGeometryPrecisionUnits);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
