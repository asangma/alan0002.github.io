dojo.provide("esri.tests.tasks.closestfacility.closest_onSolveCompleteTest");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closest_onSolveCompleteTest", [{
    name: "closest_onSolveCompleteTest",
    timeout: 3000,
    runTest: function(){
