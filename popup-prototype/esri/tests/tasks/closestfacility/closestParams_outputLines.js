dojo.provide("esri.tests.tasks.closestfacility.closestParams_outputLines");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_outputLines", [{
    name: "closestParams_outputLines",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.outputLines = "esriNAOutputLineStraight";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("esriNAOutputLineStraight",closestParams.outputLines);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
