dojo.provide("esri.tests.tasks.closestfacility.closestParams_directionsLanguage");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_directionsLanguage", [{
    name: "closestParams_directionsLanguage",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.directionsLanguage = "en-US";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("en-US",closestParams.directionsLanguage);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
