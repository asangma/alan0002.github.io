dojo.provide("esri.tests.tasks.closestfacility.closestParams_outputGeometryPrecision");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_outputGeometryPrecision", [{
    name: "closestParams_outputGeometryPrecision",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.outputGeometryPrecision = "1";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual(1,closestParams.outputGeometryPrecision);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
