dojo.provide("esri.tests.tasks.closestfacility.closestParams_defaultCutoffTest");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_defaultCutoffTest", [{
    name: "closestParams_defaultCutoffTest",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		console.log(closestParams.defaultCutoff);
        closestParams.defaultCutoff = 4;      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual(4,closestParams.defaultCutoff);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
