dojo.provide("esri.tests.tasks.closestfacility.closestParams_useHierarchy");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_useHierarchy", [{
    name: "closestParams_useHierarchy",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.useHierarchy = true;      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertTrue(closestParams.useHierarchy);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
