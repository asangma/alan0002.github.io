dojo.provide("esri.tests.tasks.closestfacility.closestParams_directionsLengthUnits");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_directionsLengthUnits", [{
    name: "closestParams_directionsLengthUnits",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.directionsLengthUnits = "esriKilometers";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("esriKilometers",closestParams.directionsLengthUnits);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
