dojo.provide("esri.tests.tasks.closestfacility.closestParams_impedanceAttribute");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_impedanceAttribute", [{
    name: "closestParams_impedanceAttribute",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.impedanceAttribute = "Length";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("Length",closestParams.impedanceAttribute);
