dojo.provide("esri.tests.tasks.closestfacility.closestParams_restrictionAttributes");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_restrictionAttributes", [{
    name: "closestParams_restrictionAttributes",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.restrictionAttributes = ["OneWay"];      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual(["OneWay"],closestParams.restrictionAttributes);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
