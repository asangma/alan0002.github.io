dojo.provide("esri.tests.tasks.closestfacility.closestParams_restrictionUturns");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_restrictionUturns", [{
    name: "closestParams_restrictionUturns",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.restrictUTurns = "esriNFSBNoBacktrack";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("esriNFSBNoBacktrack",closestParams.restrictUTurns);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
