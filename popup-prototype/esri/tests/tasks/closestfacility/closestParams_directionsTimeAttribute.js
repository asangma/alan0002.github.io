dojo.provide("esri.tests.tasks.closestfacility.closestParams_directionsTimeAttribute");

dojo.require("esri.tasks.closestfacility");

var closestTask, closestParams;

doh.registerGroup("tasks.closestfacility.closestParams_directionsTimeAttribute", [{
    name: "closestParams_directionsTimeAttribute",
    timeout: 3000,
    runTest: function(){
        closestParams = new esri.tasks.ClosestFacilityParameters();
		
        closestParams.directionsTimeAttribute = "Time";      
        ...
        function showResults(solveResult){
            ...
            if (solveResult == null || solveResult.length == 0) {
                ...
                try {
                    ...
                    doh.assertEqual("Time",closestParams.directionsTimeAttribute);
                    d.callback(true);
                } 
                catch (e) {
                    d.errback(e);
