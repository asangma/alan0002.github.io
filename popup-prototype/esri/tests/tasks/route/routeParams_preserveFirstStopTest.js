dojo.provide("esri.tests.tasks.route.routeParams_preserveFirstStopTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_preserveFirstStopTest", [
  {
    name: "routeParams_preserveFirstStop",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("preserveFirstStop:"+routeParams.preserveFirstStop);
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.preserveFirstStop);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
