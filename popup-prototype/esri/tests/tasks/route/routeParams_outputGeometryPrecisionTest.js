dojo.provide("esri.tests.tasks.route.routeParams_outputGeometryPrecisionTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_outputGeometryPrecisionTest", [
  {
    name: "routeParams_outputGeometryPrecision",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("outputGeometryPrecision:"+routeParams.outputGeometryPrecision);
		routeParams.outputGeometryPrecision =0.5;
        ...
        else 
        {
          try {
			...
			doh.assertEqual(0.5, routeParams.outputGeometryPrecision);
