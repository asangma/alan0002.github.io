dojo.provide("esri.tests.tasks.route.routeParams_restrictionAttributesTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_restrictionAttributesTest", [
  {
    name: "routeParams_restrictionAttributes",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("restrictionAttributes:"+routeParams.restrictionAttributes);
		routeParams.restrictionAttributes =["Avoid vehicular ferries","Avoid passenger ferries"];
        ...
        else 
        {
          try {
			...
			doh.assertEqual(["Avoid vehicular ferries","Avoid passenger ferries"], routeParams.restrictionAttributes);
