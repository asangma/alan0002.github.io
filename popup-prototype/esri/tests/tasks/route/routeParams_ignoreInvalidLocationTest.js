dojo.provide("esri.tests.tasks.route.routeParams_ignoreInvalidLocationTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_ignoreInvalidLocationTest", [
  {
    name: "routeParams_ignoreInvalidLocation",
    timeout: 3000,
    runTest: function(t)
    {
		...
		//console.debug("ignoreInvalidLocation:"+routeParams.ignoreInvalidLocation);
		routeParams.ignoreInvalidLocation = true;
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.ignoreInvalidLocation);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
