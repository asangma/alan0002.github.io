dojo.provide("esri.tests.tasks.route.routeParams_restrictUTurnsTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_restrictUTurnsTest", [
  {
    name: "routeParams_restrictUTurns",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug(routeParams.restrictUTurns);
		routeParams.restrictUTurns =esri.tasks.NAUTurn.NO_BACKTRACK;
        ...
        else 
        {
          try {
			...
			doh.assertEqual(esri.tasks.NAUTurn.NO_BACKTRACK, routeParams.restrictUTurns);
