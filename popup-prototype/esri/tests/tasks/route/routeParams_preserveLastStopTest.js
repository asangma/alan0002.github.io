dojo.provide("esri.tests.tasks.route.routeParams_preserveLastStopTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_preserveLastStopTest", [
  {
    name: "routeParams_preserveLastStop",
    timeout: 3000,
    runTest: function(t)
    {
		...
		console.debug("preserveLastStop:"+routeParams.preserveLastStop);
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.preserveLastStop);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
