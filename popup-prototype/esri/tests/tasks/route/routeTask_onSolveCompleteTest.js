dojo.provide("esri.tests.tasks.route.routeTask_onSolveCompleteTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeTask_onSolveCompleteTest", [{
    name: "onSolveComplete",
    timeout: 3000,
    runTest: function(){
        var expectedString = "Location 1 - Location 2";
        var inputPoint1, inputPoint2, graphic1, graphic2, routeParams;
