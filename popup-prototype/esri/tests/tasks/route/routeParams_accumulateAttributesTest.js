dojo.provide("esri.tests.tasks.route.routeParams_accumulateAttributesTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_accumulateAttributesTest", [
  {
    name: "routeParams_accumulateAttributes",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("accumulateAttributes:"+routeParams.accumulateAttributes);
		routeParams.accumulateAttributes=["Length","Time"];
        ...
        else 
        {
          try {
			...
			doh.assertEqual(["Length","Time"],routeParams.accumulateAttributes);
