dojo.provide("esri.tests.tasks.route.routeParams_impedanceAttributeTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_impedanceAttributeTest", [
  {
    name: "routeParams_impedanceAttribute",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("impedanceAttribute:"+routeParams.impedanceAttribute);
        ...
        else 
        {
          try {
			...
			doh.assertEqual("Time", routeParams.impedanceAttribute);
