dojo.provide("esri.tests.tasks.route.routeParams_outputLinesTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_outputLinesTest", [
  {
    name: "routeParams_outputLines",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("outputLines:"+routeParams.outputLines);
		routeParams.outputLines=esri.tasks.NAOutputLine.STRAIGHT;
        ...
        else 
        {
          try {
			...
			doh.assertEqual(esri.tasks.NAOutputLine.STRAIGHT, routeParams.outputLines);
