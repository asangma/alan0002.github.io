dojo.provide("esri.tests.tasks.route.routeParams_useStartTimeTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_useStartTimeTest", [
  {
    name: "routeParams_useStartTime",
    timeout: 3000,
    runTest: function(t)
    {
