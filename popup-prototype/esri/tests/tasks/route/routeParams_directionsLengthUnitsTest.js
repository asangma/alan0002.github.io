dojo.provide("esri.tests.tasks.route.routeParams_directionsLengthUnitsTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_directionsLengthUnitsTest", [
  {
    name: "routeParams_directionsLengthUnits",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("directionsLengthUnits:"+routeParams.directionsLengthUnits);
        ...
        else 
        {
          try {
			...
			doh.assertEqual("esriMiles", routeParams.directionsLengthUnits);
