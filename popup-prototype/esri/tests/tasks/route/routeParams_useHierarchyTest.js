dojo.provide("esri.tests.tasks.route.routeParams_useHierarchyTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_useHierarchyTest", [
  {
    name: "routeParams_useHierarchy",
    timeout: 3000,
    runTest: function(t)
    {
		...
		console.debug("useHierarchy:"+routeParams.useHierarchy);
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.useHierarchy);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
