dojo.provide("esri.tests.tasks.route.routeParams_findBestSequenceTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_findBestSequenceTest", [
  {
    name: "routeParams_findBestSequence",
    timeout: 3000,
    runTest: function(t)
    {
		...
		console.debug("findBestSequence:"+routeParams.findBestSequence);
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.findBestSequence);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
