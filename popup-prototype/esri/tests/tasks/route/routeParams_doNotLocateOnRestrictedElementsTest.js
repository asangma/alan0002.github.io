dojo.provide("esri.tests.tasks.route.routeParams_doNotLocateOnRestrictedElementsTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_doNotLocateOnRestrictedElementsTest", [
  {
    name: "routeParams_doNotLocateOnRestrictedElements",
    timeout: 3000,
    runTest: function(t)
    {
		...
		console.debug("doNotLocateOnRestrictedElements:"+routeParams.doNotLocateOnRestrictedElements);
        ...
        else 
        {
          try {
		  	...
		  	doh.assertTrue(routeParams.doNotLocateOnRestrictedElements);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
