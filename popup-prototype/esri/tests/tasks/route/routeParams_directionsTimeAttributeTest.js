dojo.provide("esri.tests.tasks.route.routeParams_directionsTimeAttributeTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_directionsTimeAttributeTest", [
  {
    name: "routeParams_directionsTimeAttribute",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("directionsTimeAttribute:"+routeParams.directionsTimeAttribute);
		routeParams.directionsTimeAttribute = "Time";		
	...
	function showResults(solveResult)
        ...
        else 
        {
          try {
			...
			doh.assertEqual("Time", routeParams.directionsTimeAttribute);
