dojo.provide("esri.tests.tasks.route.routeParams_outputGeometryPrecisionUnitsTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_outputGeometryPrecisionUnitsTest", [
  {
    name: "routeParams_outputGeometryPrecisionUnits",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("outputGeometryPrecisionUnits:"+routeParams.outputGeometryPrecisionUnits);
		routeParams.outputGeometryPrecisionUnits ="esriMiles";
        ...
        else 
        {
          try {
			...
			doh.assertEqual("esriMiles", routeParams.outputGeometryPrecisionUnits);
