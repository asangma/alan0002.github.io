dojo.provide("esri.tests.tasks.route.routeParams_directionsLanguageTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_directionsLanguageTest", [
  {
    name: "routeParams_directionsLanguage",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("directionsLanguage:"+routeParams.directionsLanguage);	
		routeParams.directionsLanguage = "en_US";
        ...
        else 
        {
          try {
			...
			doh.assertEqual("en_US", routeParams.directionsLanguage);
