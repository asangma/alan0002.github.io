dojo.provide("esri.tests.tasks.route.routeParams_outSpatialReferenceTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_outSpatialReferenceTest", [
  {
    name: "routeParams_outSpatialReference",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("outSpatialReference:"+routeParams.outSpatialReference);
		routeParams.outSpatialReference = new esri.SpatialReference({wkid:32662});
        ...
        else 
        {
          try {
			...
			doh.assertEqual(32662, routeParams.outSpatialReference.wkid);
		  	d.callback(true);
		  }catch(e) {
        		d.errback(e);
      		}
