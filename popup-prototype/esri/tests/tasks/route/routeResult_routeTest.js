dojo.provide("esri.tests.tasks.route.routeResult_routeTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeResult_routeTest", [
  {
    name: "routeResult_route",
    timeout: 3000,
    runTest: function()
    {
        ...
        else 
        {
          try {
		  	...
		  	doh.assertEqual("polyline", solveResult.routeResults[0].route.geometry.type);
		 	doh.assertEqual("1", solveResult.routeResults[0].route.attributes.ObjectID);
		  	d.callback(true);
		 	}catch (e) {
				d.errback(e);
			}
