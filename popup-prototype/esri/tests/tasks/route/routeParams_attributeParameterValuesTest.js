dojo.provide("esri.tests.tasks.route.routeParams_attributeParameterValuesTest");

dojo.require("esri.tasks.route");

var routeTask;

doh.registerGroup("tasks.route.routeParams_attributeParameterValuesTest", [
  {
    name: "routeParams_attributeParameterValues",
    timeout: 3000,
    runTest: function()
    {
		...
		console.debug("attributeParameterValues:"+routeParams.attributeParameterValues);
        ...
        else 
        {
          try {
			...
			console.log(routeParams.attributeParameterValues);
			doh.assertEqual([
          {
            attributeName: "Time",
            parameterName: "15 MPH",
