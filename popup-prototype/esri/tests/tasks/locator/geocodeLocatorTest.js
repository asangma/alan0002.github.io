dojo.provide("esri.tests.tasks.locator.geocodeLocatorTest");

dojo.require("esri.tasks.locator");

var locator;
doh.registerGroup("tasks.locator.geocodeLocatorTest", [{
    name: "geocode",
    timeout: 3000,
    runTest: function(t){
        var address = {
        ...
        function showResults(candidates){
            ...
            if (candidates == null || candidates.length == 0) {
                ...
                t.assertEqual(expectedCandidate.location.spatialReference.wkt,candidate.location.spatialReference.wkt);
    ...
    runTest: function(t){
        ...
        var expectedResultJSON = {
            ...
            "location": {
                "x": -117.19568260881162,
                "y": 34.057593914267962,
                "spatialReference": {
                    "wkt": "GEOGCS[\"Lat Long WGS84\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137.0,298.257223563]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433]]"
                }
            }
        ...
        function showResults(address){
            if (address == null) {
                ...
                console.log(dojo.toJson(candidateAddress));
