dojo.provide("esri.tests.tasks.geometry.areaLengthsDeferTest");


var geometryService;
doh.registerGroup("tasks.geometry.areaLengthsDeferTest", [
  
  {
    ...
    runTest: function(t)
    {
      ...
      var def = geometryService.areasAndLengths(params);
