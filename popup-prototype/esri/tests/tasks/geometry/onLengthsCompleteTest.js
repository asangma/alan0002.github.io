dojo.provide("esri.tests.tasks.geometry.onLengthsCompleteTest");



doh.registerGroup("tasks.geometry.onLengthsCompleteTest", [
  
  {
    ...
    runTest: function(t)
    {
      ...
      dojo.connect(geometryService, "onLengthsComplete", showResults);
