dojo.provide("esri.tests.tasks.geometry.onAreasAndLengthsCompleteTest");


var geometryService;
doh.registerGroup("tasks.geometry.onAreasAndLengthsCompleteTest", [
  
  {
    ...
    runTest: function(t)
    {
      ...
      function showResults(areasAndLengths)
      {
       
        if (areasAndLengths == null) 
        {
          t.assertTrue(false);
        }
        else 
        {
        	...
        	t.assertEqual(expectedArea, areas[0]);
      ...
      dojo.connect(geometryService,"onAreasAndLengthsComplete",showResults);
      geometryService.areasAndLengths(params);
