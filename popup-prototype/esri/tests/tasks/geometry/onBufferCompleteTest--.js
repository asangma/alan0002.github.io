...
doh.registerGroup("tasks.geometry.onBufferCompleteTest", [
  {
    ...
    runTest: function(t)
    {
      ...
      function showResults(graphics)
      {
        ...
        {
         t.assertEqual(1, graphics[0].geometry.rings.length); 
         t.assertEqual(4326, graphics[0].geometry.spatialReference.wkid); 
    ...
    runTest: function(t)
    {
      ...
      function showResults(graphics)
      {
        ...
        else 
        {
         ...
         //t.assertEqual(3, graphics[0].geometry.rings.length); 
         //t.assertEqual(4326, graphics[0].geometry.spatialReference.wkid); 
