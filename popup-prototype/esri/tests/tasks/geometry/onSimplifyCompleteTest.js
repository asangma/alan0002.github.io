dojo.provide("esri.tests.tasks.geometry.onSimplifyCompleteTest");

var geometryService;

doh.registerGroup("tasks.geometry.onSimplifyCompleteTest", [
  
  {
    ...
    runTest: function(t)
    {
	 ...
	 [3.75737188200003,8.83237973300004]]],"spatialReference":{"wkid":4326}};
      ...
      dojo.connect(geometryService,"onSimplifyComplete",showResults);
      geometryService.simplify(esri.getGeometries(graphics));
