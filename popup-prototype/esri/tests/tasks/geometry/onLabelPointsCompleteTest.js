dojo.provide("esri.tests.tasks.geometry.onLabelPointsCompleteTest");


var geometryService;
doh.registerGroup("tasks.geometry.onLabelPointsCompleteTest", [
  
  {
    name: "onLabelPointsComplete",
    timeout: 3000,
    runTest: function(t)
    {
      ...
      dojo.connect(geometryService,"onLabelPointsComplete",showResults);
      geometryService.labelPoints(geometries);
