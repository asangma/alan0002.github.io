dojo.provide("esri.tests.tasks.geometry.bufferDeferTest");

var geometryService;

doh.registerGroup("tasks.geometry.bufferDeferTest", [
  {
    name: "pointGraphic",
    timeout: 3000,
    runTest: function(t)
    {
      ...
      //params.features = graphics; //pre-2.0
	  params.distances = [ 5, 10 ]; 
	  params.geometries = esri.getGeometries(graphics); // features needs to be an array of geometries
      ...
      var def = geometryService.buffer(params);
