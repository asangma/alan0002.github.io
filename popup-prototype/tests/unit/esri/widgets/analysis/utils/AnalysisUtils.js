define(
  ...
  "dojo/cookie"
 ...
 ], function (FeatureLayer, array, dojoJson, lang, Deferred, cookie) {
    ...
    lang.mixin(analysisUtils, {
      ...
      init: function (testConfig) {
        ...
        cookie("esri_auth", dojoJson.toJson(testConfig.auth));
      ...
      analyze: function (toolName) {
        ...
        params.context = dojoJson.toJson(contextObj);
