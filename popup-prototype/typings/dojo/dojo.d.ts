...
interface IPromise<T, E> {
	...
	isRejected(): boolean;
	isResolved(): boolean;
	otherwise<U, F>(errback?: (reason: E) => IPromise<U, F> | U | void): IPromise<T | U, E | F>;
...
declare module 'dojo/string' {
	var string: {
		...
		substitute(template: string, map: any, transform?: (s: string) => string, thisObject?: Object): string;
	};
